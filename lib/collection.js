...
// -------------------------------------------- Add Colours Score to DB
  ...
  addColoursScore: function(childId, correctScores, incorrectScores) {
...
// -------------------------------------------- Create Colour Game Question
  ...
  createColourQuestion: function() {
    
    var nextRandomColour = coloursArray[Math.floor(Math.random()*coloursArray.length)];
    
    console.log("The createColour random colour is " + nextRandomColour);
